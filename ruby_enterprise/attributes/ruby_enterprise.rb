...
default[:ruby_enterprise][:version]      = '1.8.7-2010.01'
default[:ruby_enterprise][:url]          = "http://rubyforge.org/frs/download.php/68719/ruby-enterprise-#{ruby_enterprise[:version]}"
