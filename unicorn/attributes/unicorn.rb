...
default_unless[:unicorn][:listen][:type] = 'tcp'
...
default_unless[:unicorn][:preload_app] = true
default_unless[:unicorn][:before_fork] = true
default_unless[:unicorn][:after_fork]  = true
